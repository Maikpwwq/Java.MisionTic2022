...
public class Libro
{
    ...
    /**
     * Actualizacion del precio de venta segun descuento del libro.
     */
    private boolean precioDescontado;
    ...
    /**
     * Retorna el precio de venta actualizado para este libro.
     * @return El precio de venta incluye el valor por descuento del libro.
     */
    public void aplicarDescuento ( double descuento )
    {
        precioVenta = precioVenta * (1-descuento) ;
        precioDescontado = true;
    }

    /**
     * Retorna si el valor tiene aplicado el descuento del libro.
     * @return El precio de venta incluye el descuento del libro.
     */
    public boolean darPrecioDescontado( )
    {
